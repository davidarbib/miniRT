...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/29 01:15:52 ol                #+#    #+#             */
/*   Updated: 2020/01/29 01:15:53 by pqueiroz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (
		mlx_int_xpm_f_image(xvar, width, height, XpmReadFileToImage, filename)
	);
}
...
{
	return (
		mlx_int_xpm_f_image(xvar, width, height, XpmCreateImageFromData,
							(void *)data)
	);
}
