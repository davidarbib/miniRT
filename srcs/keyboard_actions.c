...
/*   Updated: 2020/07/20 15:50:17 by darbib           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void assign_key_fts(void)
{
	...
	g_key_pressed_ft[KEY_Q] = move_up;
	g_key_pressed_ft[KEY_E] = move_down;
	...
	g_key_pressed_ft[KEY_N] = roll;
	g_key_pressed_ft[KEY_M] = inv_roll;  
	g_key_pressed_ft[KEY_TAB] = cam_switch;  
	g_key_pressed_ft[KEY_ESCAPE] = normal_exit;  
	g_key_pressed_ft[KEY_L] = res_switch;  
}
